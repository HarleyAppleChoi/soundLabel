...
# First find out under which docker network the "github.com/HarleyAppleChoi/interview-polyAI/backend" project is available (as started via ./docker-helper.sh --up).
